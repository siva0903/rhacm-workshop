...
```
<hub> $  oc apply -f https://raw.githubusercontent.com/siva0903/rhacm-workshop/master/06.Advanced-Policy-Management/exercise-compliance-operator/policy-moderate-scan.yaml
```
